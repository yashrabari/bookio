...
<div class="container">
	<div class="category-posts row">
		...
		<?php endif; ?>
		<div class="cate-post-content <?php echo esc_attr($sidebar_blog); ?> <?php if(is_active_sidebar('sidebar-blog')){ echo esc_attr(bookio_get_class()->class_blog_content); }else{ echo "col-lg-12 col-md-12 col-sm-12 col-xs-12"; } ?>">
