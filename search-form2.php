	...
	<?php if($terms_author){ ?>
		<div class="select_authors">
			<div class="select_author pwb-dropdown dropdown">
				<span class="pwb-dropdown-toggle dropdown-toggle" data-toggle="dropdown"><?php echo esc_html__("Author",'bookio'); ?></span>
				<span class="caret"></span>
				<ul class="pwb-dropdown-menu dropdown-menu author-search">
					<li data-value="" class="<?php  echo (($term->slug == $author_slug) ?  esc_attr("active") : ""); ?>"><?php echo esc_html__("All Author",'bookio'); ?></li>
